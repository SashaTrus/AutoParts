...
<div class="container">
    <div class="mt-5 text-center">
        <h2>Добавить объявление о прадаже запчасти</h2>
    </div>
    <form class="m-5" action="../controller/addparttodb.php" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <select class="form-select" name="gearboxtype" id="gearboxtype">
                <option selected>Механика</option>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="partnumber" id="partnumber" placeholder="Номер запчасти" value="" required="">
        </div>
        <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="partdescription" id="partdescription" placeholder="Описание" value="" required="">
        </div>
        <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="price" id="price" placeholder="Цена" value="" required="">
            <span class="input-group-text" id="inputGroup-sizing-default">$</span>
        </div>
        <div class="text-center">
            <button class="btn btn-success btn-danger mt-3 px-5" type="submit">Добавить объявление</button>
        </div>
    </form>
    <div class="text-center">
